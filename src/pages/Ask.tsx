  ...
  return (
    <div>
      ...
      <div className="flex justify-center items-center h-full py-36">
        <div className="border-customPink border-2 w-1/2">
          <div className="flex flex-col items-center my-10">
            <p className="text-2xl font-bold mb-2">Drop Your Question Here!</p>
            ...
            <div className="flex justify-between mt-10 space-x-5">
              <button
                ...
                className="sm:text-xl font-zain bg-slate-200 sm:py-2 sm:px-5 rounded-lg text-md"
              >
                Back
              </button>
              <button className="sm:text-xl font-zain bg-customPink sm:py-2 sm:px-5 rounded-xl text-md">
                Ask
              </button>
            </div>
          </div>
