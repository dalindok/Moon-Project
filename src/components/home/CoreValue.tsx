        ...
        <div>
            ...
            <div className='flex flex-col items-center mt-10'>
                <div className='flex flex-col md:flex-row md:justify-between justify-center items-center'>
                    <div className='bg-pink-200 mx-4 my-2 md:mx-10 md:my-4 rounded-lg flex-grow w-96 h-auto p-4'>
                        <p className='font-bold'>Community Support:</p>
                        <p>Connect, share, and grow with a supportive skincare community.</p>
                    </div>
                    <div className='bg-pink-200 mx-4 my-2 mt-3 md:mx-4 md:my-4 rounded-lg flex-grow w-96 h-auto p-4'>
                ...
                <div className='bg-pink-200 rounded-lg w-96 h-auto justify-center mt-3 md:mt-10 p-4 flex-grow'>
