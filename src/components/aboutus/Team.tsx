...
const Team: React.FC = () => {
  return (
    <div className="text-center px-4 py-10">
      <h1 className="text-4xl sm:text-7xl md:text-6xl font-bold mb-2">Meet</h1>
      <h2 className="text-3xl sm:text-6xl md:text-5xl font-semibold text-rose-300 mb-6">Our Team</h2>
