...
import logo from '../../assets/article/Profile.png';

function ArticlePart() {
    return (
        <div className="bg-customPink rounded-lg p-6 m-5 max-w-2xl mx-auto mt-1 shadow-lg md:p-8 lg:max-w-4xl">
            ...
            <div className="bg-customPink rounded-md p-2 md:p-4 flex justify-center items-center mb-4">
                <img src={logo} alt="Article Visual" className="w-full h-48 md:h-80 lg:h-96 rounded-sm object-cover" />
            </div>
            <div className="space-y-4 text-start text-sm md:text-base">
                <p>
